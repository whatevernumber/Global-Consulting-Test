        ...
        <form class='registration_form' @submit.prevent="form.post('/register')">
            <div>
                <label class="registration_label">
                    ...
                    <input :class="['registration_input', { input_error: form.errors.name }]" name="name" required v-model="form.name">
                </label>
            ...
            <div>
                <label class="registration_label">
                    ...
                    <input :class="['registration_input', { input_error: form.errors.email }]" type="email" name="email" required v-model="form.email">
                </label>
            ...
            <div>
                <label class="registration_label">
                    ...
                    <input class='registration_input' :class="['registration_input', { input_error: form.errors.password }]" type="password" name="password" required v-model="form.password">
                </label>
            ...
            <div>
                <label class="registration_label">
                    ...
                    <input class='registration_input' type="password" name="password_confirmation" required v-model="form.password_confirmation">
                </label>
                <div class='validation_error' :class="['registration_input', { input_error: form.errors.password_confirmation }]" v-if="form.errors.password_confirmation">{{ form.errors.password_confirmation }}</div>
            </div>
