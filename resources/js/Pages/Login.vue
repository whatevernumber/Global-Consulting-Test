        ...
        <form class='login_form' @submit.prevent="form.post('/login')">
            <div>
                <label class="login_label">
                    ...
                    <input :class="['login_input', { input_error: form.errors.email }]" name="email" required v-model="form.email">
                </label>
            ...
            <div>
                <label class="login_label">
                    ...
                    <input :class="['login_input', { input_error: form.errors.password }]" type="password" name="password" required v-model="form.password">
                </label>
